...
from bot.handlers.prices import (
    explain_coin,
    prompt_coin_search,
...
def build_application() -> Application:
    ...
    application.add_handler(CallbackQueryHandler(show_ai_market_summary, pattern=f"^{CALLBACK_MARKET_AI}$"))
    application.add_handler(CallbackQueryHandler(prompt_coin_search, pattern=f"^{CALLBACK_SEARCH_COIN}$"))
    ...
    application.add_handler(CallbackQueryHandler(show_coin_price, pattern=f"^{CALLBACK_PREFIX_SEARCH_RESULT}.+"))
